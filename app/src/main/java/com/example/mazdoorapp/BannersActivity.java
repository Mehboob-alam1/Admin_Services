...
import com.example.mazdoorapp.databinding.ActivityBannersBinding;
...
public class BannersActivity extends AppCompatActivity {
    ...
    private ActivityBannersBinding binding;
    ...
    private DatabaseReference databaseReference,imageData;
    Uri selectedImageUri,simpleUri;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageRef= FirebaseStorage.getInstance().getReference("Image");
        databaseReference= FirebaseDatabase.getInstance().getReference("Banners");
        imageData= FirebaseDatabase.getInstance().getReference();
...
//        String fileName = "images"; // Set a unique filename for the image
//        StorageReference imageRefe = imageRef.child(fileName);
...
// Register a listener to track the upload progress and handle the completion
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                imageRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri downloadUri) {
                        ...
                        uploadToDataBaseLink(imageUrl,link);
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception exception) {
                        dialog.dismiss();
                        Toast.makeText(BannersActivity.this, ""+exception.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
    ...
    private void uploadToDataBaseLink(String imageUrl, String link) {


        Image image = new Image(imageUrl,link);
...
//                        simpleUri  = data.getData();
//                        binding.imageSimple.setImageURI(simpleUri);
//            }
        }
    }
